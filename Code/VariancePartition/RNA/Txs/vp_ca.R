...
expr_ca <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Txs/Y1Y2/log2TMM1_CentralAmyg.RDS")
expr_dg <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Txs/Y1Y2/log2TMM1_DG.RDS")
expr_mpfc <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Txs/Y1Y2/log2TMM1_mPFC.RDS")


expr_ca <- as.data.frame(expr_ca)
expr_ca <- expr_ca[rowSums(expr_ca) > 0,]
...
expr_dg <- expr_dg[rowSums(expr_dg) > 0,]
...
expr_mpfc <- expr_mpfc[rowSums(expr_mpfc) > 0,]
expr_mpfc <- expr_mpfc[,rownames(info_mpfc)]
expr_mpfc <- as.matrix(expr_mpfc)

varPart_ca1 <- fitExtractVarPartModel(expr_ca, form1, info_ca)
saveRDS(varPart_ca1, "~/daskalakislab/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Txs/VarPartFiles/Y1Y2/CentralAmyg.RDS")
