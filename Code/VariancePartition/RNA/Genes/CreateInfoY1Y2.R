...
saveRDS(anno_y1y2, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/InfoFiles/Y1Y2/All_All.RDS")
...
saveRDS(anno_y1y2_mPFC, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/InfoFiles/Y1Y2/All_mPFC.RDS")

# CentralAmyg
anno_y1y2_CentralAmyg <- anno_y1y2_brains$CentralAmyg
unique(anno_y1y2_CentralAmyg$Brain_Region)=="CentralAmyg"
saveRDS(anno_y1y2_CentralAmyg, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/InfoFiles/Y1Y2/All_CentralAmyg.RDS")

# DG
anno_y1y2_DG <- anno_y1y2_brains$DG
unique(anno_y1y2_DG$Brain_Region)=="DG"
saveRDS(anno_y1y2_DG, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/InfoFiles/Y1Y2/All_DG.RDS")
...
# saveRDS(anno_y1y2_mdd_mPFC, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/InfoFiles/Y1Y2/MDD_mPFC.RDS")
# 
# # MDD CentralAmyg
...
# saveRDS(anno_y1y2_mdd_CentralAmyg, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/InfoFiles/Y1Y2/MDD_CentralAmyg.RDS")
# 
# # MDD DG
