...
vall <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Genes/Voom_Y1Y2_DG.RDS")
info <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Protein/VariancePartition/NewCovs/InfoFiles/Y1Y2/All_DG.RDS")
out_file <- "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/NewCovs/VarPartFiles/Y1Y2/ae_all_DG.RDS"
