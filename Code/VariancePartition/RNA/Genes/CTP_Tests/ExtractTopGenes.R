...
mPFC_ae <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/CTP_Tests/VarPartFiles/mPFC_ae.RDS")
mPFC_ae <- prep_vp(mPFC_ae)
top_mPFC <- run_extraction(mPFC_ae,10)
saveRDS(top_mPFC, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/CTP_Tests/TopGenes/top_mPFC_ae.RDS")
