...
saveRDS(varPart_ca1, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/VarPartFiles/Y1Y2/CentralAmyg_ae_age2_ctp9.RDS")

# varPart_ca2 <- fitExtractVarPartModel(expr_ca, form2, info_ca)
# saveRDS(varPart_ca2, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/VarPartFiles/Y1Y2/CentralAmyg_gPCs.RDS")
# 
# varPart_ca3 <- fitExtractVarPartModel(expr_ca, form3, info_ca)
# saveRDS(varPart_ca3, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/VarPartFiles/Y1Y2/CentralAmyg_aPCs.RDS")
# 
