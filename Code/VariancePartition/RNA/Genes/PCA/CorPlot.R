...
form <- ~ `AgeDeath`+`Sex`+`PMI`+`PTSD`+`MDD`+`Control`+
  ...
  `RNA_Gene_PC1`+`RNA_Gene_PC2`+`RNA_Gene_PC3`+`RNA_Gene_PC4`+`RNA_Gene_PC5`+
...
cor_Y1Y2(info=info_ca, form=form, out_file="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/PCA/CorFiles/Y1Y2/CentralAmyg.RDS")
cor_Y1Y2(info=info_dg, form=form, out_file="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/PCA/CorFiles/Y1Y2/DG.RDS")
cor_Y1Y2(info=info_mpfc, form=form, out_file="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/PCA/CorFiles/Y1Y2/mPFC.RDS")
...
#   tiff(filename = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/PCA/CorPlots/Y1Y2/",out_file),
...
plot_cor <- function(wd, file,title){
  ...
  C <- readRDS(paste0(wd,file))
  pdf(file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/PCA/CorPlots/Y1Y2/",out_file),
      width = 20,height = 20)
  plotCorrMatrix(C, margins=c(35,35), main=title)
  dev.off()
}

wd <- "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/PCA/CorFiles/Y1Y2/"
