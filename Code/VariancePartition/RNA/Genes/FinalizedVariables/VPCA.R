...
saveRDS(varPart_ca, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/FinalizedCovs/VarPartFiles/Y1Y2/CentralAmyg_ctp7.RDS")
