...
vall_ca <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Jxs/Y1Y2/VoomCentralAmyg.RDS")
vall_dg <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Jxs/Y1Y2/VoomDG.RDS")
vall_mpfc <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Jxs/Y1Y2/VoommPFC.RDS")
...
saveRDS(varPart_ca1, "~/daskalakislab/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Jxs/VarPartFiles/Y1Y2/CentralAmyg.RDS")
