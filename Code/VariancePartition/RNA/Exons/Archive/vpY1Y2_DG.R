...
vall <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Exons/Voom_Y1Y2_DG.RDS")
info <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/InfoFiles/Y1Y2/NewCovs/All_DG.RDS")
out_file <- "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Exons/VarPartFiles/Y1Y2/ancestry_estimates_all_DG.RDS"
varpart_Y1Y2(info=info, vall=vall, form=form_ancestry_est_all_split,out_file=out_file, multi_region=F)

vall <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Exons/Voom_Y1Y2_DG.RDS")
info <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/InfoFiles/Y1Y2/NewCovs/All_DG.RDS")
out_file <- "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Exons/VarPartFiles/Y1Y2/ancestry_pcs_all_DG.RDS"
varpart_Y1Y2(info=info, vall=vall, form=form_ancestry_pc_all_split,out_file=out_file, multi_region=F)

vall <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Exons/Voom_Y1Y2_DG.RDS")
info <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Genes/InfoFiles/Y1Y2/NewCovs/All_DG.RDS")
out_file <- "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/VariancePartition/Exons/VarPartFiles/Y1Y2/genetic_pcs_all_DG.RDS"
