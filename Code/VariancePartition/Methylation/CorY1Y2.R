...
cor_Y1Y2(info=info_ca, form=form, out_file="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/VariancePartition/CorFiles/Y1Y2/CentralAmyg_neuron.RDS")
cor_Y1Y2(info=info_dg, form=form, out_file="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/VariancePartition/CorFiles/Y1Y2/DG_neuron.RDS")
cor_Y1Y2(info=info_mpfc, form=form, out_file="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/VariancePartition/CorFiles/Y1Y2/mPFC_neuron.RDS")
...
plot_cor <- function(wd, file,title){
  ...
  C <- readRDS(paste0(wd,file))
  pdf(file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/VariancePartition/CorPlots/Y1Y2/",out_file),
      width = 10,height = 10)
  plotCorrMatrix(C, margins=c(17,17), main=title)
  dev.off()
}

wd <- "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/VariancePartition/CorFiles/Y1Y2/"
