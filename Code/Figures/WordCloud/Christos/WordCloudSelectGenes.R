genes <- fread2("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Select_gene_v1.csv")
...
pdf(file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Clouds/Christos/SelectGenes.pdf"),
    width = 10,
    height = 10)
...
ggsave(filename = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Clouds/Christos/SelectGenes_Barplot.pdf",
       plot=p,
       device="pdf",
       units="in",
       width=10,
