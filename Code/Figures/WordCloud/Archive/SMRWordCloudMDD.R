...
pdf(file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Clouds/SMR/MDDGenesSMR.pdf"),
    width = 10,
    height = 10)
...
ggsave(filename = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Clouds/SMR/MDDGenesSMR_Barplot.pdf",
       plot=p,
       device="pdf",
       units="in",
       width=10,
