...
pdf(file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Clouds/SMR/AllGenesSMR_sum.pdf"),
    width = 10,
    height = 10)
...
ggsave(filename = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Figures/WordCloud/Clouds/SMR/AllGenesSMR_Barplot_sum.pdf",
       plot=p,
       device="pdf",
       units="in",
       width=10,
