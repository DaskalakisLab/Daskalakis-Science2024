...
run_enrichment <- function(wd, mod_file,disease,region){
  ...
  fnIn_list <- list.files(paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Enrichment/InputForEnrichment/Magma",disease),full.names = T)
  
  enrich <- userListEnrichment(geneR=genes, 
                               labelR=mods, 
                               fnIn = fnIn_list, 
                               nameOut = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Enrichment/RNA/Results/",disease,"Magma/",region,"/",out_file,".csv"), 
                               useBrainLists = FALSE, 
  ...
  saveRDS(enrich, paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Enrichment/RNA/Results/",disease,"Magma/",region,"/",out_file,".RDS"))
