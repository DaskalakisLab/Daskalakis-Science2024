...
for (region in regions){
  limma_wrapper(
    ...
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_PTSD.RDS"),
    ...
    analysis = "Suicide012",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/SuicidePTSD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_MDD.RDS"),
    covariates = c("Suicide012","AgeDeath","Sex","PMI","ancestryPC1","ancestryPC2","Astro","inhib","ex","Oligo","Micro","OPC","Tcell","mitoMapped"),
    contrast_var = "Suicide012",
    analysis = "Suicide012",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/SuicideMDD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_PTSD_MDD.RDS"),
    covariates = c("Suicide012","AgeDeath","Sex","PMI","ancestryPC1","ancestryPC2","Astro","inhib","ex","Oligo","Micro","OPC","Tcell","mitoMapped"),
    contrast_var = "Suicide012",
    analysis = "Suicide012",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/SuicidePTSD_MDD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_PTSD.RDS"),
    ...
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/ChildTraumaPTSD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_MDD.RDS"),
    ...
    analysis = "ChildTrauma012",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/ChildTraumaMDD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_PTSD_MDD.RDS"),
    ...
    analysis = "ChildTrauma012",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/ChildTraumaPTSD_MDD/"
  )
}