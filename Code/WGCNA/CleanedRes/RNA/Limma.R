...
for (region in regions){
  limma_wrapper(
    ...
    analysis = "PTSD",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/PTSD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    ...
    analysis = "MDD",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/MDD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    ...
    analysis = "PTSD_MDD",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/PTSD_MDD/"
  )
  limma_wrapper(
    anno_file = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/Annotation_Y1Y2Y3.RDS",
    expr_file = paste0("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/MEsForLimma/",region,"/ME_PTSD_vs_MDD.RDS"),
    covariates = c("PTSD","AgeDeath","Sex","PMI","ancestryPC1","ancestryPC2","Astro","inhib","ex","Oligo","Micro","OPC","Tcell","mitoMapped"),
    contrast_var = "PTSD",
    analysis = "PTSD_vs_MDD",
    region = region,
    out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/WGCNA/CleanedRes/RNA/Limma_Results/PTSD_vs_MDD/"
  )
}