...
fileToLoad="ressler_r3tmt_18batch_multiconcensus_PeptideGroups.txt"
...
outputFilename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Protein/TamporNormalized/Y3/Peptides/1b.PD.TMT_Peptides_Y3.NoCorrection.RDS"
...
symbolLookup<-readxl::read_excel("/data/humgen/daskalakislab/dipietro/SciencePaper/Code/PDabundanceLoader/2020-preference+2015_UniprotID-symbolLookupTableForR.xlsx") #column names will be set below to "Uniprot.ID" and "Symbol"
