...
########### Configuration ########################
rootdir="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Protein/Bulk/"
...
fileToLoad="kressler_b1andb2_50batch_multiconcensus-(1)_Proteins.txt"
...
outputFilename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Protein/TamporNormalized/Y1Y2.TMT_rawAbundances.NoCorrection.RDS"
...
symbolLookup<-readxl::read_excel("/data/humgen/daskalakislab/dipietro/SciencePaper/Code/PDabundanceLoader/2020-preference+2015_UniprotID-symbolLookupTableForR.xlsx") #column names are set below to "Uniprot.ID" and "Symbol"
...
cleanDat.new <- as.data.frame(cleanDat.new)
saveRDS(cleanDat.new, file=outputFilename)
