...
all <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Exon/Y1Y2Y3_removed_exon/DGE_mPFC.RDS")
dim(all)
# 556496    229
...
filename="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y1Y2Y3_removed_exon/VoomPFC.RDS"

saveRDS(vall,file=filename)


Cairo::CairoPDF(file="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y1Y2Y3_removed_exon/VoomPFC.pdf")
