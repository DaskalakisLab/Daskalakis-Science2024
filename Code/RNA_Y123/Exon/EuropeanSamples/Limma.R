...
sink("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Exons/Y1Y2Y3/EuropeanSamples/log.txt")
...
for (region in regions){
  ...
  limma_wrapper(anno_file = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS", 
                voom_file = paste0("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y123/EuropeanSamples/Voom",region,".RDS"), 
                region = region, 
                dx="PTSD", 
                ptsd_vs_mdd = F, 
                ptsd_mdd = F, 
                ...
                contrast_var = "PTSD", 
                out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Exons/Y1Y2Y3/EuropeanSamples/PTSD/")
  ...
  limma_wrapper(anno_file = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS", 
                ...
                contrast_var = "MDD", 
                out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Exons/Y1Y2Y3/EuropeanSamples/MDD/")
  ...
  #               out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Exons/Y1Y2Y3/EuropeanSamples/PTSD_MDD/")
  # 
  # limma_wrapper(anno_file = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS",
  #               voom_file = paste0("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y123/EuropeanSamples/Voom",region,".RDS"),
  #               region = region, 
  ...
  #               covariates = c("PTSD","AgeDeath","Sex","PMI","ancestryPC1","ancestryPC2","Astro","inhib","ex","Oligo","Micro","OPC","Tcell","mitoMapped","batch"), 
  #               contrast_var = "PTSD",
  #               out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Exons/Y1Y2Y3/EuropeanSamples/PTSD_vs_MDD/")
}
...
# }
#results_MDD_DG_MDD <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/results/LimmaResults/RNA/Exons/Y123/MDD/results_MDD_DG_MDD.RDS")
