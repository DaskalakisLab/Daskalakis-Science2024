...
all <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Exon/EU_Y1Y2Y3/DGE_CentralAmyg.RDS")
dim(all)
...
filename="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y123/EuropeanSamples/VoomCentralAmyg.RDS"
...
Cairo::CairoPDF(file="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y123/EuropeanSamples/VoomCentralAmyg.pdf")
