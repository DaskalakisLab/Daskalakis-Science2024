...
all <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Exon/EU_Y1Y2Y3/DGE_DG.RDS")
dim(all)
# 58037   230
...
filename="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y123/EuropeanSamples/VoomDG.RDS"
...
Cairo::CairoPDF(file="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Exons/Y123/EuropeanSamples/VoomDG.pdf")
