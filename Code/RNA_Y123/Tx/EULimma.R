...
sink("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Txs/Y1Y2Y3/EuropeanSamples/log.txt")
...
for (region in regions){
  limma_wrapper(anno_file = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS", 
                ...
                contrast_var = "PTSD", 
                out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Txs/Y1Y2Y3/EuropeanSamples/PTSD/")
  ...
  limma_wrapper(anno_file = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS", 
                ...
                contrast_var = "MDD", 
                out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Txs/Y1Y2Y3/EuropeanSamples/MDD/")
  ...
  #               out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Txs/Y1Y2Y3/EuropeanSamples/PTSD_MDD/")
  # 
  # limma_wrapper(anno_file = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS", 
  #               voom_file = paste0("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Txs/Y1Y2Y3/log2TMM1_",region,".RDS"), 
  #               region = region, 
  ...
  #               covariates = c("PTSD","AgeDeath","Sex","PMI","ancestryPC1","ancestryPC2","Astro","inhib","ex","Oligo","Micro","OPC","Tcell","mitoMapped","batch"), 
  #               contrast_var = "PTSD", 
  #               out_folder = "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/LimmaResults/RNA/Txs/Y1Y2Y3/EuropeanSamples/PTSD_vs_MDD/")
}
