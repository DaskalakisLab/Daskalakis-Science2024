...
all <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Jx/Y1Y2Y3/DGE_CentralAmyg.RDS")
dim(all)
# 5523949     229
...
filename="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Jxs/Y1Y2Y3/VoomCentralAmyg.RDS"
