...
# BiocManager::install("edgeR", version = "3.12")
#Ioulia version 4.1.2
#Mo 4.2.0
...
# common_columns <- intersect(colnames(annoy12), colnames(annoy3))
# 
# # Subset tables based on common column names
# annoy123 <- rbind(annoy12[, common_columns], annoy3[, common_columns])
# 
# saveRDS(annoy123, "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/Annotation_Y123.RDS")

annoy123 <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/Annotation/EU_Annotation_Y123_updatedPCs.RDS")
...
saveRDS(dge_ca_y123, "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Gene/EU_Y1Y2Y3/DGE_CentralAmyg.RDS")
saveRDS(dge_dg_y123, "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Gene/EU_Y1Y2Y3/DGE_DG.RDS")
saveRDS(dge_mpfc_y123, "/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Gene/EU_Y1Y2Y3/DGE_mPFC.RDS")
