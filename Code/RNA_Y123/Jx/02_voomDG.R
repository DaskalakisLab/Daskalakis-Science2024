...
all <- readRDS("/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Counts/Jx/Y1Y2Y3/DGE_DG.RDS")
dim(all)
# 5523949     230
...
filename="/data/humgen/daskalakislab/SciencePaper_Mo_Ioulia/Data/RNA/Voom/Jxs/Y1Y2Y3/VoomDG.RDS"
