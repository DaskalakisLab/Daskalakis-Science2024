...
expr_ca <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/AartiNormalized/Y3/CentralAmygMfunnorm.RDS")
expr_ca <- as.data.frame(t(expr_ca))
PC_ca <- calculate_PCs(expr_ca)
PC_ca <- as.data.frame(PC_ca)


expr_dg <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/AartiNormalized/Y3/DGMfunnorm.RDS")
expr_dg <- as.data.frame(t(expr_dg))
PC_dg <- calculate_PCs(expr_dg)
PC_dg <- as.data.frame(PC_dg)


expr_mpfc <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/AartiNormalized/Y3/mPFCMfunnorm.RDS")
expr_mpfc <- as.data.frame(t(expr_mpfc))
PC_mpfc <- calculate_PCs(expr_mpfc)
PC_mpfc <- as.data.frame(PC_mpfc)


saveRDS(PC_ca, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/PCA/Y3/PCA_CentralAmyg.RDS")
saveRDS(PC_dg, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/PCA/Y3/PCA_DG.RDS")
saveRDS(PC_mpfc, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/PCA/Y3/PCA_mPFC.RDS")
