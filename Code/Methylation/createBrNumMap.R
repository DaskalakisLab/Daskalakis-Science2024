...
setwd('/data/humgen/daskalakislab/jajoo/TACC/DNAmethylation/NormalizedData/')
...
baseDir <- "/data/humgen/daskalakislab/jajoo/TACC/DNAmethylation/RawData/ImageData/"
targets <- read.metharray.sheet('/data/humgen/daskalakislab/jajoo/TACC/DNAmethylation/metadata',pattern = "methylation_data_dictionary.csv")
...
JoelPTDSY2 <- read.csv('/data/humgen/daskalakislab/jajoo/TACC/DNAmethylation/metadata/Joel_PTSD_R01_Y2_DNA_Packing_Slips_to_FC_12-17-2020.csv',stringsAsFactors = FALSE,header = TRUE,sep=",")
...
methDicDemo <- read.csv('/data/humgen/daskalakislab/jajoo/TACC/DNAmethylation/methylation_data_dictionary_with_some_demographic_data.csv',stringsAsFactors = FALSE,header = TRUE,sep=",")
...
saveRDS(methmap, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/BrNumMapping/Y1Y2BrNumMap.RDS")
