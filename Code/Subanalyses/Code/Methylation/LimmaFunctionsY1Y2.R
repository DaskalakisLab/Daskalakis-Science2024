...
limma_wrapper <- function(anno_file, expr_file, region, dx=NULL, ptsd_vs_mdd = F, ptsd_mdd = F, sex=NULL, 
  ...
  expr_br_dx <- expr_br_dx[,anno_br_dx$SampleID]
...
# contrast_var = "PTSD"
# out_folder = "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Methylation/Limma_Results/SexSpecific/Y1Y2/PTSD_Male/"
