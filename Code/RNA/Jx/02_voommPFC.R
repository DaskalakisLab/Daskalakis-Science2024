...
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Counts/Jx/Y1Y2/DGE_mPFC.RDS")
dim(all)
# 5523949     150
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Jxs/Y1Y2/VoommPFC.RDS"
...
#################################################################################################################
# Read DGE list created in /data/humgen/daskalakislab/dipietro/SciencePaper/Code/RNA/Jx/01_DGE.R
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Counts/Jx/Y3/DGE_mPFC.RDS")
dim(all)
# 5523949      79
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/RNA/Voom/Jxs/Y3/VoommPFC.RDS"
