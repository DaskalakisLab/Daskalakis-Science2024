...
df <- fread2(paste0(wd,"DLPFC_231.predpc_oneweek.header"))
...
saveRDS(df,"/data/humgen/daskalakislab/dipietro/SciencePaper/Data/GlobalAncestry/DLPFC231/GlobalAncestryDLPFC231.RDS")
