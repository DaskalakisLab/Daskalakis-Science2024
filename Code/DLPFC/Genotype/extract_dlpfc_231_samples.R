dlpfc_samples <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/SampleMap/DLPFC_Samples_231.RDS")
...
write.table(dlpfc_samples, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/IDsToKeep/dlpfc231IDs.txt", sep="\t", row.names = F, col.names = F, quote = F)
