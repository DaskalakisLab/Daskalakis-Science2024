res_dirs <- list.dirs("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/Subanalyses/DLPFC", recursive = T)
res_dirs <- res_dirs[endsWith(res_dirs, "PTSD") | endsWith(res_dirs, "MDD")]
