res_dirs <- list.dirs("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/LimmaResults/SexSpecific/DLPFC", recursive = T)
res_dirs <- res_dirs[endsWith(res_dirs, "Male") | endsWith(res_dirs, "Female")]
