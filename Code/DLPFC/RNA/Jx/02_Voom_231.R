...
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Counts/Jxs/DGE_DLPFC_231.RDS")
dim(all)
# 5879582   231
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Voom/Jxs/VoomDLPFC231.RDS"
