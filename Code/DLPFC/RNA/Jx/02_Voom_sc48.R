...
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Counts/Jxs/DGE_DLPFC_48.RDS")
dim(all)
# 5879582   48
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Voom/Jxs/VoomDLPFC48.RDS"
