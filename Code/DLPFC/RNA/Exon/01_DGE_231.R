...
metadata <- as.data.frame(rse_exon@colData@listData)
...
saveRDS(dge_dlpfc_231, "/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Counts/Exons/DGE_DLPFC_231.RDS")
