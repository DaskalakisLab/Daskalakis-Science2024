...
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Counts/Exons/DGE_DLPFC_231.RDS")
dim(all)
# 571612   231
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Voom/Exons/VoomDLPFC231.RDS"
