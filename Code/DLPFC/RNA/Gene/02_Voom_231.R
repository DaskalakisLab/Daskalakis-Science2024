...
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Counts/Genes/DGE_DLPFC_231.RDS")
dim(all)
# 58037   231
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Voom/Genes/VoomDLPFC231.RDS"
