...
all <- readRDS("/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Counts/Genes/DGE_DLPFC_48.RDS")
dim(all)
# 58037   48
...
filename="/data/humgen/daskalakislab/dipietro/SciencePaper/Data/DLPFC/RNA/Voom/Genes/VoomDLPFC48.RDS"
